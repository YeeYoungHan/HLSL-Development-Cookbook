...
D3DXVECTOR3 g_vLightPosition = D3DXVECTOR3(0.0f, 55.0f, 15.0f);
D3DXVECTOR3 g_vLightDirection;
float g_fLightRange = 85.0f;
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    DXUTCreateWindow( L"Point Light PCF Shadows" );
...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
	...
	g_LightManager.AddPointLight( g_vLightPosition, g_fLightRange, g_vLightColor, g_bCastShadow);
}
