...
public:
	...
	// Render the each lights volume in wireframe
	...
	// Enable/disable PCSS
	void EnablePCSS(bool bEnablePCSS) { m_bEnablePCSS = bEnablePCSS; }
...
private:
	...
	ID3D11PixelShader* m_pSpotLightPCSShadowPixelShader;
	...
	// Enable using PCSS shadows for all shadowing lights
	bool m_bEnablePCSS;
