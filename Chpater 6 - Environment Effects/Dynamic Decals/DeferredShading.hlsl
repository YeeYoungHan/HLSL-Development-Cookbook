...
/////////////////////////////////////////////////////////////////////////////
// Dynamic decals pixel shaders
/////////////////////////////////////////////////////////////////////////////

PS_GBUFFER_OUT RenderDecalPS( VS_OUTPUT In )
{
	PS_GBUFFER_OUT Out;
	
	// Pack the GBuffer values as usual
	float4 DiffuseColor = DiffuseTexture.Sample( LinearSampler, In.UV );
	DiffuseColor.xyz *= DiffuseColor.xyz;
	Out = PackGBuffer(DiffuseColor.rgb, normalize(In.Normal), 1.0, 50.0);

	// Just output alpha instead of spec for now
	Out.ColorSpecInt.a = DiffuseColor.a;
