...
float g_fLightRange = 35.0f;
float g_fLightOuterAngle = 55.0f;
float g_fLightInnerAngle = 45.0f;
                                     ...
                                     void* pUserContext )
{
	...
	g_arrLightPositions[0] = D3DXVECTOR3(35.0f, 13.0f, 20.16f);
	g_arrLightPositions[1] = D3DXVECTOR3(-35.0f, 13.0f, 20.16f);
	g_arrLightPositions[2] = D3DXVECTOR3(0.0f, 13.0f, -40.46f);
