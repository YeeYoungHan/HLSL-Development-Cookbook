                                     ...
                                     void* pUserContext )
{
	...
	g_arrLightColor[0] = D3DXVECTOR3(1.25f, 0.0f, 0.0f);
	g_arrLightColor[1] = D3DXVECTOR3(0.0f, 1.25f, 0.0f);
	g_arrLightColor[2] = D3DXVECTOR3(0.0f, 0.0f, 1.25f);
