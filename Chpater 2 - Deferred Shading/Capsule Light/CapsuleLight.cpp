...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    DXUTCreateWindow( L"Capsule Light" );
                                     ...
                                     void* pUserContext )
{
	...
	g_arrLightDirections[0] = g_arrLightPositions[2] - g_arrLightPositions[1];
	D3DXVec3Normalize( &g_arrLightDirections[0], &g_arrLightDirections[0] );
	g_arrLightDirections[1] = g_arrLightPositions[0] - g_arrLightPositions[2];
